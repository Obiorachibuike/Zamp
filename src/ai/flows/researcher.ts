...
const ResearchTopicOutputSchema = z.object({
  summary: z
    .string()
    .describe(
      'A detailed summary of the research topic.'
    ),
  links: z
    .array(LinkSchema)
...
const prompt = ai.definePrompt({
  ...
  prompt: `You are an expert researcher. Your task is to provide a detailed summary and a list of relevant links for the given topic.
